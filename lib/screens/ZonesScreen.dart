...
void _editZone(Map<String, dynamic> zone) {
  ...
  final chargeController = TextEditingController(text: zone['charge'].toString());
  final payableController = TextEditingController(text: zone['payable'].toString());
  final justEatChargeController = TextEditingController(text: '0.00'); // Add if needed
        ...
        content: Column(
          ...
          children: [
            ...
            TextField(
              ...
              decoration: const InputDecoration(labelText: 'Just Eat Delivery Charge'),
              keyboardType: TextInputType.number,
            ),
          ],
        ),
        actions: [
          ...
          ElevatedButton(
            onPressed: () async {
              ...
              final apiUrl =
                  'https://www.takeawayordering.com/appserver/appserver.php?tag=editdeliveryzone&employee_phone=wingsbox&employee_pin=2go2hell&shop_id=$_shopId&delivery_zone_name=${zoneController.text}&delivery_charge=${chargeController.text}&delivery_payment=${payableController.text}&jeat_delivery_charge=${justEatChargeController.text}&zone_id=${zone['id']}';
        ...
        actions: [
          ...
          ElevatedButton(
            onPressed: () async {
              ...
              final apiUrl =
                  'https://www.takeawayordering.com/appserver/appserver.php?tag=createdeliveryzone&employee_phone=wingsbox&employee_pin=2go2hell&shop_id=$_shopId&delivery_zone_name=${zoneController.text}&delivery_charge=${chargeController.text}&delivery_payment=${payableController.text}&jeat_delivery_charge=${justEatChargeController.text}';
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        Row(
                          mainAxisAlignment: MainAxisAlignment.spaceBetween,
                          children: [
                            Text('Delivery Charge: €${zone['charge']}'),
                            Text('Payable: €${zone['payable']}'),
                          ],
                        ),
                        const SizedBox(height: 8),
                        Row(
