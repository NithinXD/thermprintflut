...
class _OrderDetailsScreenState extends State<OrderDetailsScreen> {
  ...
  const int totalWidth = 32; // Total receipt width (printer width)
  ...
  for (var item in _orderDetails ?? []) {
    ...
    // Wrap item name while keeping words intact
...
/// Helper function to wrap text into multiple lines while keeping words intact
